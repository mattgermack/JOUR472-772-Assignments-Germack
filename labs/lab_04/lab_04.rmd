...
**A1.** Jain Ashwandi's group spent the most money of any committee on Facebook in the expenses dataset, with two different Peter Franchot groups(one a campaign and one a committee) are two and three.
...
media_expenses_clustered <- read_csv("data/media-expenses-clustered.csv")
...
**A2.** Jain, Franchot, Baron and King ran for governor(Jain also ran for the House), Boniface ran as a county executive, Jasani ran for BCPS board and Shuman ran for PGCC. WFP is a progressive political party, and CASA in Action is a progressive group focused on Black/brown issues.

It appears as though most candidates had their ads deleted? But those that remain up are largely information-based; as in they try and give facts/figures to back their position rather than appealing emotionally or with ethos.
...
**A3.** Wes Moore is notably missing. His biggest recepient of media expenses, by FAR, is SKDK, a company that does political affairs/consulting for Democratic candidates. The fact other payees didn't receive more, or any, is very likely because they were paid by SKDK separately.
...
**A4.** Yes - among possibly others, Ashwani Jain, Jon Baron and one of Peter Franchot's committees.
...
**A5** In my opinion, we really don't know much about money being spent on Facebook, or in general. Moore and Baron, the two major candidates, paid most of their money to party-sponsored consultant firms that likely spent the money on Facebook for them. The biggest takeaway is that smaller candidates who are funding themselves don't stand a chance in advertising competition — they're getting laps ran around them by major PACs and party-sponsored candidates that bring in hundreds of thousands of dollars. And in my opinion, the biggest story is that advertising money is convoluded and shady. And there's way, way too much of it.
