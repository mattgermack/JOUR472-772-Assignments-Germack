...
**Task** Run the following code and describe the dataframe it outputs. **Answer**Cases of doctors in MD getting complaints and what that complaint was, from 2014 to 2024.
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer**A list of all of the unique words(or more accurately, strings of characters, since capitalization is not accounted for)
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer**A list of every word used in a complaint's text in the entire dataset.
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer**A bar graph showing us the most commonly used words across text entries in the dataset. We don't learn a lot from this specific graph, because most of these words are stopwords.
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer**Yes, much so, but we don't necessarily have context.
...
**Task** Run the following code and describe the results. **Answer**These lists give us the most commonly used words in each year, removing stop words.
...
**Task** Run the following code and describe the results. **Answer**This code allows us to create a bigram, two words commonly used together to provide more context. This gives us the most commonly used bigrams before Jan 2024. 
...
**Task** Run the following code and describe the results. **Answer**We get the 10 most commonly used bigrams prior to 2024.
...
**Task** Run the following code and describe the results. **Answer**We get the 10 most commonly used bigrams during 2024.
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer**We get the most commonly used words in 2023 and 2022, how many times they were used and the associated sentiment of that word. I feel like there should be a bigram association instead, to avoid words that can be used in many ways like "appropriate", and there should be a category for words like "patient" that are neutral in tone.
