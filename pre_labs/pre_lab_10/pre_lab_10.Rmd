...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer** Zip code, name of area, statistics on the size/shape of each zip code
...
**Task** Run the following code. Describe the output in the space below. **Answer**A detailed, minimalist map of Maryland based on zip code, with graph lines at every half degree of latitude and full degree of longitude.
...
**Task** Run the following code. Describe the output in the space below. **Answer**Name/data/size/shape for every county in the country.
...
**Task** Run the following code. Describe the output in the space below. **Answer**A county-by-county map of Maryland
...
**Task** Run the following code. Describe the output in the space below. **Answer**An overlay of the county and zip code maps of Maryland.
...
**Task** Run the following code. Describe the output in the space below. **Answer** We're loading data of foreclosures by MD zip code, and creating a new dataset with just foreclosures in March 2023, then looking at that data.
...
**Task** Run the following code. Describe the output in the space below. **Answer**Using left_join, we add map data by zip code to the foreclosure data, allowing us to set up a map.
...
**Task** Run the following code. Describe the output in the space below. **Answer**We get a colorized and stylized map of foreclosures by zip code, with color varying by volume of foreclosures.
...
**Task** Run the following code. Describe the output in the space below. Be sure to input your census api key. **Answer** This is loading all of the necessary packages
...
**Task** Run the following code. Describe the output in the space below. **Answer**We are creating a dataset for foreclosure data in Maryland by county, then creating a separate dataset from census data on age/sex.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The dataset now includes geometric data for each county's population so that we can create a map chart with it.
...
**Task** Run the following code. Describe the output in the space below. **Answer** md_county_notices has counties in a "county" column, while md_county_population has them in a "NAME" column.
...
**Task** Run the following code. Describe the output in the space below. **Answer**We're renaming the column so both are labeled "NAME" then removing the ", Maryland" from each datapoint so that they are the same in each dataset.
...
**Task** Run the following code. Describe the output in the space below. **Answer**The datasets are now joined by county.
...
**Task** Run the following code. Describe the output in the space below. **Answer**Charles County and PG County have the highest number of foreclosure notices per 1000 people.
...
**Task** Run the following code. Describe the output in the space below. **Answer**A map of foreclosure notices in Maryland by county, with higher-volume counties being bluer and lower-volume being blacker.
...
**Task** Run the following code. Describe the output in the space below. **Answer**The color scheme has changed to purple/pink/orange/off-white
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer**The rates are more proportional to the range of the data.
