...
**Task** Run the following code and describe the dataframe it outputs. **Answer**A table describing each of the four statistical variables by state, which is the fifth variable
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer**There is a slight positive correlation, but the relationship doesn't look particularly strong, because about half the data points exist outside the predicted shade.
...
**Task** Run the following code. Describe the plot. What do you see? **Answer**A slight negative line-of-best-fit with data that follows a stronger pattern, but still not much of one.
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer**This table reflects the graph of a slight negative correlation that isn't strong. 
...
**Task** Run the following code. Describe the model output. What do you see? **Answer** A Pearson correlation coefficient test, which shows a very low p-value and likely statistcal significance.
...
**Task** Run the following code. Describe the model output. What do you see? **Answer**This test gives us a p-value of .68, which is much higher and not statistically significant.
...
**Task** Run the following code. Describe the table. What do you see? **Answer**GDP growth and mean $ spent on education per student is higher in Biden states, and mean population growth is much higher in Trump states.
...
**Task** Run the following code. Describe the output. What do you see? **Answer**This test gives us the means for each group and t-test statistics. A p-value of 0.074 could be significant at an alpha of .10, but using the .05 we used in class, it shows this difference is not statistically significant.
...
**Task** Run the following code. Describe the output. What do you see? **Answer** This t-test gives us a p-value of .0001, which is statistically significant at any reasonable alpha value.
