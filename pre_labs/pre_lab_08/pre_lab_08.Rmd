...
Mutate creates a month column and label=true labels the rows as the actual month. Calls are grouped by month and counted up per month.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** A "blank canvas"
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer**An actual bar graph with basic labels for each axis
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer**Bars are reordered smallest to largest
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** Bars are horizontal now instead of vertical
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The background is white instead of gray
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer**The background is a blue shade and there is a white line underneath each horizontal bar.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** There is a heading for the graph and each axis has a general label.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer**A standard R table with the data
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer**A very chaotic line graph with the total amount of calls by month.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer**X axis lines are labeled by date, but it's way too jammed together to read it properly.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer**The dates are put at a diagonal so that they are readable and discernable from each other.
